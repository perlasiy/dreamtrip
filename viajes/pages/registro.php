...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || !filter_var($email, FILTER_VALIDATE_EMAIL)) $errores[] = "Ingrese un email válido";
...
$mostrar_exito = isset($_SESSION['registro_exitoso']) && $_SESSION['registro_exitoso'];
if ($mostrar_exito) unset($_SESSION['registro_exitoso']);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>DreamTrip - Registro</title>
    <style>
        :root {
       ...
       /* Carrusel */
        ...
        .form-image {
            flex: 1;
            background: url('../assets/images/brasil2.jpg') center/cover no-repeat;
        }
        ...
        .alert-success {
            color:rgb(0, 0, 0);/**lo cambie si no sirve era verde */
...
/* Font Awesome para los iconos (agregar en el head) */
    </style>
</head>
<body>
    <header class="main-header">
        ...
        <nav class="main-nav">
            <ul>
                ...
                <li><a href="#" style="color:rgb(0, 0, 0); font-weight: bold;">Inscribirse</a></li>
        ...
        <div class="form-content">
            ...
            <form method="post">
                <div class="form-group">
                    <label for="descripcion" style="font-weight:200; ">Por favor registrese aquí</label>
                ...
                <button type="submit" class="btn-submit">Registrarse</button>
                 <a href="ingreso.php">Olvidaste tu contraseña?</a> | 
            </form>
        </div>
    </div>
